...
print('<center>username pawan </br>  password pawan</center>')
print("<br></br>")
...
sp.getoutput("sudo docker run -dit --name {c} -p 2000:4200 {i}".format(c=cname,i=imgname))
#print("hi")
...
for i,j,k in zip(list1_images[1:],list1_names[1:],list1_status[1:]):
	...
	if 'Up' in str:
		...
		print("<td><a target='cframe' href='http://192.168.43.251:2000'>Get</a></td></tr>")
